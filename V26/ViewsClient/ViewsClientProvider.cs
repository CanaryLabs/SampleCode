...
namespace ViewsClient
{
    ...
    public class ViewsClientProvider : GrpcClientProviderBase<CanaryViewsApiServiceClient, ViewsClientConnectionContext>
    {
        ...
        public static async Task<int> GetCciAsync(CanaryViewsApiServiceClient client)
        {
            ...
            if (getCciResponse.Status.StatusType == Canary.Views.Grpc.Common.ApiCallStatusType.InvalidCci)  // NoLicense for V26.1 and lower
                throw new Exception("Failed to get client connection id.");
